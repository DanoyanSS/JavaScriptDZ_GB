...
$('#cityB').on('click', function () {
  ...
  var city = $('#city').val();
  var apiURI2 = "https://api.openweathermap.org/data/2.5/forecast?q=".concat(city, "&appid=9e0a358471279c0a50bdf4d741edf121");
  ...
  function dataHandler3(data) {
    ...
    var hoursTime = newDate.getHours();
    var num = 8 - Math.floor(hoursTime / 3); //завтра
